  ...
  return (
    <div className="">
      ...
      <p className="text-body font-body">
        ...
        Where do we draw the line on what we will and won't design to ensure humans are empowered, not erased nor exploited. This project is currently
        being developed and researched but will be an interactive experience for site visitors to take part in.
      </p>
      <p className="text-body font-body">
        Once finished it will be featured here.
      </p>
    </div>
  );
};
